...
Contributions are highly welcome. If you want to feel like a HexoNerds, feel free to address your Extension or Bug Fix by Pull Request (PR) to us.

When contributing to one of our repositories, please first discuss the change you wish to make via issue,
email, or any other method with the owners of this repository before making a change.

Please note we have a code of conduct, please follow it in all your interactions with the project. Find it below.

## PR Procedure

* Fork our project and clone your fork
* Create a new branch and check it out by `git checkout -b mynewbranch`
...
our Support - see the bottom of this page.
